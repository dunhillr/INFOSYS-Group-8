...
class Delivery extends Model
{
    ...
    protected $fillable = ['sale_id','customer_id','vehicle_id','destination','delivery_date','delivery_time','status','assigned_by','delivered_by','notes','proof_of_delivery','is_opened'];
