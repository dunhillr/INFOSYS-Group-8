...
class ReportController extends Controller
{
    ...
    {
        $sales = Sale::with(['product', 'customer', 'user'])->latest()->paginate(20);
        return view('reports.sales', compact('sales'));
    }

    public function production(): View
    {
        $productions = Production::with('user')->latest()->paginate(20);
    ...
    {
        $deliveries = Delivery::with(['sale', 'customer', 'vehicle'])->latest()->paginate(20);
