...
<div class="block justify-between page-header md:flex mt-4">
    <div>
        <h3 class="!text-defaulttextcolor dark:!text-defaulttextcolor/70 font-semibold">Add User</h3>
    </div>
    <ol class="flex items-center whitespace-nowrap min-w-0">
        ...
        <li class="before:content-['/'] before:mx-2 text-sm text-textmuted truncate">Add User</li>
    </ol>
</div>
            ...
            <div class="box-header">
                <div class="flex items-center gap-2">
                    <span class="inline-flex items-center justify-center w-8 h-8 rounded-full bg-primary/10">
                        <i class="ri-user-add-line text-primary text-base"></i>
                    </span>
                    <h5 class="box-title mb-0">New User Information</h5>
                </div>
            </div>
            <div class="box-body">
                <form action="{{ route('users.store') }}" method="POST" id="createUserForm">
                    ...
                    <div class="flex items-center gap-3 mt-6 pt-4 border-t border-defaultborder dark:border-defaultborder/10">
                        <button type="submit" class="ti-btn ti-btn-primary-full !font-medium min-w-[120px]">
            ...
            <div class="box-body space-y-4">
                ...
                <div class="flex items-start gap-3 p-3 rounded-md bg-warning/5 border border-warning/10">
                    ...
                    <div>
                        ...
                        <p class="text-textmuted text-xs">Use a strong password with at least 8 characters. Mix letters, numbers, and symbols.</p>
                    </div>
                </div>
            </div>
        </div>
